# Generated by Django 3.0.6 on 2020-06-01 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(null=True, to='catalog.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a language (e.g. Portuguese)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
